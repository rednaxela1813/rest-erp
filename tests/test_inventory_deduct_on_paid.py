...
def test_paying_order_deducts_product_stock(admin_client, payment_factory, capture_payment_api, lot_factory):
    ...
    r1 = client.post(
        ...
        data={"product": str(product.public_id), "qty": "2", "unit": str(unit.public_id), "unit_price": "5.00", "tax_rate": str(tax.public_id)},
